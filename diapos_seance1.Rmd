...
# Evaluation
 ...
 - individuelle sur un jeu de donnée (4 semaines, Régression Logistique)
 - data challenge ()
...
- Le modèle conditionnel de $Y$ sachant $X$ est: $(Y|X = x) \sim B(\pi(x))$
...
- Ainsi: $\lim_{n\to\infty} \sqrt{n}(\widehat{\beta}-\beta) \rightarrow N(0,\sum^{-1})$ avec $\sum^{-1}$ la matrice de variance-covariance de $\beta$ 
