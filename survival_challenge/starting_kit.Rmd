...
**Warning**  
  ...
  - The Challenge 2 will be opened from 5pm to 6pm. 
  
## How do I get information?
  
Section 2 indicates where to find information about metadata.

Section 3 and 4 explain how to load the data and how to identify the patients.

Section 5 and 6 display exemples of data exploration.

Please go to section 7 to see an exemple of result submission on the platform.

## What will be the evaluation?

At 6 pm, you will have to return a report of 10 pages maximum including an introduction, the methods you used, and a discussion of the results obtained.
